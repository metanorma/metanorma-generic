        ...
        output =
          { accesseddate: "XXX",
            ...
            metadata_extensions: { "doctype" => "standard",
                                   "editorialgroup" => { "committee_type" => "A", "committee" => "TC" }, "security" => "Client Confidential", "insecurity" => "Client Unconfidential" },
            obsoleteddate: "XXX",
            publisheddate: "XXX",
            publisher: "Acme",
            receiveddate: "XXX",
    ...
    input = <<~INPUT
      <generic-standard xmlns="http://riboseinc.com/isoxml">
        ...
        <terms id="H" obligation="normative" displayorder="1"><fmt-title id="_">1.&#160; Terms, Definitions, Symbols and Abbreviated Terms</fmt-title>
          <term id="J">
          <fmt-name id="_4c90b6bb-5c92-ee5d-63a6-a0c998553311"><span class="fmt-caption-label"><semx element="autonum" source="_3fb81d2d-0459-918b-ed88-4fd3a5b94587">1</semx><span class="fmt-autonum-delim">.</span><semx element="autonum" source="term-Term-1">1</semx><span class="fmt-autonum-delim">.</span></span></fmt-name>
